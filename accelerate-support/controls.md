...
- Trigger: Used to interact with interfaces over a distance. Point the controller at an interface, and if a beam appears, press Trigger to send a click event.
